...
<body>
	...
	<div class="container">
		<div class="hero-unit">
			<div>
				<h1>
					Welcome to Fitness Tracker! <small><sec:authentication
							property="name"
						/> </small>
				</h1>
			...
			<a class="btn btn-primary" href="addMinutes.html"> Add Exercise
				Minutes » </a>
			<a class="btn btn-primary" href="getGoalReports.html"> Get Goal
				Reports » </a>
			<a class="btn btn-warning" href="j_spring_security_logout">Logout
				» </a>
		</div>
	</div>
